...
const Carousels = React.lazy(() =>
  import("./app/conponents/base/carousels/Carousels")
);
const Collapses = React.lazy(() =>
  import("./app/conponents/base/collapses/Collapses")
);
const BasicForms = React.lazy(() =>
  import("./app/conponents/base/forms/BasicForms")
);

const Jumbotrons = React.lazy(() =>
  import("./app/conponents/base/jumbotrons/Jumbotrons")
);
const ListGroups = React.lazy(() =>
  import("./app/conponents/base/list-groups/ListGroups")
);
const Navbars = React.lazy(() =>
  import("./app/conponents/base/navbars/Navbars")
);
const Navs = React.lazy(() => import("./app/conponents/base/navs/Navs"));
const Paginations = React.lazy(() =>
  import("./app/conponents/base/paginations/Pagnations")
);
const Popovers = React.lazy(() =>
  import("./app/conponents/base/popovers/Popovers")
);
const ProgressBar = React.lazy(() =>
  import("./app/conponents/base/progress-bar/ProgressBar")
);
const Switches = React.lazy(() =>
  import("./app/conponents/base/switches/Switches")
);

const Tabs = React.lazy(() => import("./app/conponents/base/tabs/Tabs"));
const Tooltips = React.lazy(() =>
  import("./app/conponents/base/tooltips/Tooltips")
);
const BrandButtons = React.lazy(() =>
  import("./app/conponents/buttons/brand-buttons/BrandButtons")
);
const ButtonDropdowns = React.lazy(() =>
  import("./app/conponents/buttons/button-dropdowns/ButtonDropdowns")
);
const ButtonGroups = React.lazy(() =>
  import("./app/conponents/buttons/button-groups/ButtonGroups")
);
const Buttons = React.lazy(() =>
  import("./app/conponents/buttons/buttons/Buttons")
);
...
const CoreUIIcons = React.lazy(() =>
  import("./app/conponents/icons/coreui-icons/CoreUIIcons")
);
...
const Alerts = React.lazy(() =>
  import("./app/conponents/notifications/alerts/Alerts")
);
const Badges = React.lazy(() =>
  import("./app/conponents/notifications/badges/Badges")
);
const Modals = React.lazy(() =>
  import("./app/conponents/notifications/modals/Modals")
);
const Colors = React.lazy(() => import("./app/conponents/theme/colors/Colors"));
const Typography = React.lazy(() =>
  import("./app/conponents/theme/typography/Typography")
);
...
const routes = [
  ...
  {
    path: "/gestionUtil/compteLocataire",
    name: "TableLocataire",
    component: UsersTable,
  },
  //----------------- Stats routes:
  {
    path: "/stats/locataire",
    name: "SatatsLocataire",
    component: LocatairesTable,
  },
